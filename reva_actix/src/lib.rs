...
pub fn into_response<T: ?Sized + reva::Template>(tmpl: &T) -> HttpResponse<BoxBody> {
...
pub fn try_into_response<T: ?Sized + reva::Template>(
    tmpl: &T,
...
/// Newtype to let reva::Error implement actix_web::ResponseError.

...
//! For more information, read the [book](https://djc.github.io/reva/filters.html).
...
use reva_escape::{Escaper, MarkupDisplay};
...
///
/// Reva will automatically insert the first (`Escaper`) argument,
